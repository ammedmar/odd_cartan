...
\anibal{Question: How to prove the existence of relators in general using a specific construction? Is it true that modifying the may-st structure gives equivariantly homotopic $F$'s and $G$'s. Probably one needs to fix the basic algebra structure on $A$.}
