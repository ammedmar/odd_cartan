...
In order to prove that $K_3 \colon \cW(r) \to \cC(r) \ot \cC(r)$ is a $\cyc$-equivariant chain homotopy between $(\iota \ot \iota) \circ \Delta$ and $\Delta_{\AW} \circ \iota$ we proceed as follows.
