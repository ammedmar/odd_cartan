...
In this section we prove that $K_3 \colon \cW(r) \to \cC(r) \ot \cC(r)$, as defined in \cref{ss:coproduct}, is a $\cyc$-equivariant homotopy from $\Delta_{\AW} \circ \iota$ to $(\iota \ot \iota) \circ \Delta$.
