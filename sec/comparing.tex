...
In this section we prove that $K_3 \colon \cW(r) \to \cC(r) \ot \cC(r)$, as defined in \cref{ss:coproduct}, is a $\cyc$-equivariant homotopy between $(\iota \ot \iota) \circ \Delta$ and $\Delta_{\AW} \circ \iota$.
