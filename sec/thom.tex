...
It is not difficult to verify that these maps are as follows:
\begin{align*}
...
\end{align*}
where the first sum in each formula iterates along all $s_1,\ldots,s_i$ in $\cyc_r$, and the action of $\rho$ transforms a simplex $(a_1,\ldots,a_n)$ into $(a_1+k,\ldots,a_n+k)$. The first values of $L_1$ for $p=3$ are computed in Table \ref{f:small values of L_1}. 
