...
The functor of chains $\chains \colon \sSet \to \Ch$ from simplicial sets to chain complexes does not preserve products, but we there are natural chain maps
\[
\begin{tikzcd}
...
\]
There are explicit closed form formulas describing these maps.
They can be found for example in \cite[56]{real2000homological}.
