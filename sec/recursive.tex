...
\begin{remark*}
	...
	\]
	Using this language, an idempotent homotopy identity is a strong deformation retract satisfying (i), and we remark that \cref{t:recursive construction} is an adaptation of \cite[p.367]{Lambe-Stasheff}.
\end{remark*}
%OLD remark*}
